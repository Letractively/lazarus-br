...
uses
  Forms, ComCtrls, StdCtrls, ExtCtrls, MaskEdit, CEPLivre, DB, Dialogs,
...
begin
  ...
  try
    ...
    if TipoConsultaComboBox.ItemIndex = 0 then
      B := DemoCEPLivre.Consultar(VCodigoRespostaHTTP, CEPEdit.Text)
    else
      B := DemoCEPLivre.Consultar(VCodigoRespostaHTTP, '', CidadeEdit.Text,
